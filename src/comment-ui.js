...
function ensureComposerStyle() {
  ...
  st.textContent = [
    ...
    // platform's red marker overstates the case: a faint wave in the text's
    // own grey. Chromium ignores a colour-only override on this pseudo, so the
    // full shorthand sets the line too.
    '.cu-ta::spelling-error{text-decoration:underline wavy rgba(31,35,40,.3)}',
    ...
    '.cu-dark .cu-ta::spelling-error{text-decoration:underline wavy rgba(241,243,244,.3)}',
