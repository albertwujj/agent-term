...
This terminal makes that quick: it is already a better tool for working with your agents, including the work to fix itself. [Change its source](docs/sessions.md#bootstrap), and the next window you open has your improvement in it.
