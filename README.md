...
Further sessions start from the app: with a window in front, `Ctrl/Cmd+Shift+N` opens another, and so does a right-click on its taskbar button or Dock tile ([sessions](docs/sessions.md)).
