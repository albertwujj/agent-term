...
| Its plans are append-only text. | Ask for the plan as a markdown file and click its name: the doc opens rendered, you **[write in the rendered page](docs/plan.md)** and the agent maintains the source. |
