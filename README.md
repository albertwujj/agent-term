...
The rest are optional loops: plans and reviews (one repo covers both), the checkout lock, long jobs, the phone view, the IDE jump. Ask your agent for the ones you want. For example, this adds plans and reviews:
