...
*Each frame at full size:* [Sessions 1](docs/assets/frames/sessions-1.png?raw=true) · [Sessions 2](docs/assets/frames/sessions-2.png?raw=true) · [Resume](docs/assets/frames/resume.png?raw=true) · [Comment](docs/assets/frames/comment.png?raw=true) · [Docs 1](docs/assets/frames/docs-1.png?raw=true) · [Docs 2](docs/assets/frames/docs-2.png?raw=true) · [Docs 3](docs/assets/frames/docs-3.png?raw=true) · [Code 1](docs/assets/frames/code-1.png?raw=true) · [Code 2](docs/assets/frames/code-2.png?raw=true) · [Code 3](docs/assets/frames/code-3.png?raw=true) · [Phone 1](docs/assets/frames/phone-1.png?raw=true) · [Phone 2](docs/assets/frames/phone-2.png?raw=true).
...
Once it opens, [resume your previous session](docs/sessions.md#resume-an-existing-cli-session) or [start a new one](docs/sessions.md#start-an-agent), and work as usual. When you want to give precise feedback or ask a question, [select and enter a comment](docs/comment.md).
