...
Use it first as it is, a boost for working with your agents; what you need may already be there. When something is missing or falls short in your situation, add it with your agents, in this terminal, with the boost it gives them: the symptom is right there, in front of you and the agents, who are in a good position to evaluate and build the fix or the addition. The loop itself runs better in this terminal: you comment on the symptom where you see it, settle the fix on a page, and review it before it lands. With agents at your disposal, you can fit the tool to your work, which you know best.
