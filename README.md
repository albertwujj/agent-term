...
Extending it on demand is what keeps it a terminal. Things come in only when you need them, and the window is a terminal again the moment you finish. An IDE does not do that, as irrelevant things are already there before you type.
