...
The loop's instruction docs live in [agent-threads](https://github.com/albertwujj/agent-threads): reference [produce-review.md](https://github.com/albertwujj/agent-threads/blob/main/code/produce-review.md) in a prompt and the agent produces the package and hands out the link for this terminal host.
