...
You don't have to scroll back for a link the agent printed: `Ctrl/Cmd+Shift+U` opens one of your recent viewers, and typing finds files that never appeared in the terminal ([open a viewer](viewer.md)).
