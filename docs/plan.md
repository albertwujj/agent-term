...
The same loop is a writing aid in its own right. An essay, notes, research, a post: anything you write in a repo uses it, and the copy button takes the draft out when it is ready.
