...
The same loop is a writing aid in its own right. An essay, notes, research, a post: the working directory organizes your context, and the copy button takes the draft out when it is ready.
