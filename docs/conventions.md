...
Two places a clone can live. Which fits depends on who reads the docs: the terminal, for the runbooks the terminal resolves itself (voice-to-agent), or you, for the verb docs you pick with `@` (agent-lock, and agent-threads' `produce-review.md`).
