...
If selecting ever stops working, the CLI is painting its own screen instead of printing into this one, and a selection cannot reach what it paints — hold `Shift` and it will. [How a CLI draws](dev/cli-rendering.md) covers why, and the settings that change it.
